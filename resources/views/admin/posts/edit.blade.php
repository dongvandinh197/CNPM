...
@section('content')
	...
	@endif
	<div class="col-md-8">
		<form action="{{ route('posts.update',$posts->id) }}" id="save-post-form" method="post" enctype="multipart/form-data" >
			{{csrf_field()}}
			<div class="form-group">
				<label for="title">Tên bài viết:</label>
				<input type="text" class="form-control" id="title" name="title" value="{{$posts->title}}" onkeyup="generateSlug();">
			</div>
			...
			<div class="form-group">
				...
				<img src="{{asset($posts->feature)}}" alt="" width="400">
			</div>
			...
			<div class="form-group">
				...
				<textarea name="content" id="" cols="30" rows="20" class="form-control">{{$posts->content}}</textarea>
			</div>
